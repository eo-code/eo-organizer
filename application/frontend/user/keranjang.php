...
<body>
      ...
      <div class="modal-content">
        ...
        <form id="myForm">
          ...
          <div class="modal-footer">
            ...
            <button style="border: none;background-color: #8675a9;color: #ffffff;" class="btn btn-primary" type="submit">Pesan</button>
          </div>
      </div>
    </div>
  </div>
  ...
  <script>
    ...
    myForm.addEventListener('submit', function(event) {
      ...
      const myProduct = JSON.stringify({
        products: dataCart,
      });

      const myData = new FormData(this);
      // myData.append("products", myProduct);


      // console.log(typeof myData);

      fetch("../../backend/user/booking/proses.php", {
        method: "POST",
        body: myData
